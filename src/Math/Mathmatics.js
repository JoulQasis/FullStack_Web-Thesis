...
function Mathmatics() {
  ...
  // const question = document.getElementById("container1");
    ...
    <main className={mathCss.main}>
      ...
      <div className={mathCss.container}>
        <div className={mathCss.container1}>
          <p className={mathCss.p1}></p>
        </div>
        <button className={mathCss.submitbtn} id="submit-btn">
          Submit
        </button>
        <button className={mathCss.startbtn} id="start-btn">
          Start
        </button>
      </div>
    </main>
